  ...
  return (
    <input
      ...
      className={cn(
        ...
        "focus-visible:border-brand-lavender-darker focus-visible:ring-[3px] focus-visible:ring-brand-lavender/30 focus-visible:shadow-[0_0_0_3px_oklch(0.82_0.08_258/0.25)]",
