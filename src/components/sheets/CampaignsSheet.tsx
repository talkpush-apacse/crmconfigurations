    ...
    <div>
      <SheetIntro
        ...
        description={
          <>
            <p>
              Define your recruitment campaigns. Each campaign represents a job
              position or hiring pipeline.
            </p>
            {referenceData.map((r) => (
              <p key={r.type}>
      ...
      <TabUploadBanner tabKey="campaigns" tabLabel="Campaigns List" compact />
